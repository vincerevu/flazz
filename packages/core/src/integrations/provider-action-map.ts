...
const PROVIDER_ACTION_MAP: Record<string, ProviderActionPreferences> = {
  ...
  pexels: {
    list: ["PEXELS_CURATED_PHOTOS", "PEXELS_POPULAR_VIDEOS", "PEXELS_FEATURED_COLLECTIONS", "PEXELS_MY_COLLECTIONS", "PEXELS_COLLECTION_MEDIA"],
    search: ["PEXELS_SEARCH_PHOTOS", "PEXELS_SEARCH_VIDEOS"],
    read: ["PEXELS_GET_PHOTO"],
  },
  hubspot: {
