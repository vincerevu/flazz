...
```bash
"%FLAZZ_PYTHON%" "%FLAZZ_SKILL_ROOT%\create-spreadsheets\scripts\xlsx_unpack.py" input.xlsx /tmp/xlsx_fmt/
```
...
"%FLAZZ_PYTHON%" "%FLAZZ_SKILL_ROOT%\create-spreadsheets\scripts\style_audit.py" /tmp/xlsx_fmt/unpacked/

# Formula error static scan (must specify a single .xlsx file, does not accept directories)
# Pack first, then scan:
"%FLAZZ_PYTHON%" "%FLAZZ_SKILL_ROOT%\create-spreadsheets\scripts\xlsx_pack.py" /tmp/xlsx_fmt/unpacked/ /tmp/output.xlsx
"%FLAZZ_PYTHON%" "%FLAZZ_SKILL_ROOT%\create-spreadsheets\scripts\formula_check.py" /tmp/output.xlsx
```
...
```bash
"%FLAZZ_PYTHON%" "%FLAZZ_SKILL_ROOT%\create-spreadsheets\scripts\xlsx_pack.py" /tmp/xlsx_fmt/unpacked/ output.xlsx
```
