...
```bash
"%FLAZZ_PYTHON%" "%FLAZZ_SKILL_ROOT%\create-spreadsheets\scripts\xlsx_reader.py" input.xlsx                 # full report
"%FLAZZ_PYTHON%" "%FLAZZ_SKILL_ROOT%\create-spreadsheets\scripts\xlsx_reader.py" input.xlsx --sheet Sales   # single sheet
"%FLAZZ_PYTHON%" "%FLAZZ_SKILL_ROOT%\create-spreadsheets\scripts\xlsx_reader.py" input.xlsx --quality       # quality audit only
"%FLAZZ_PYTHON%" "%FLAZZ_SKILL_ROOT%\create-spreadsheets\scripts\xlsx_reader.py" input.xlsx --json          # machine-readable
```
