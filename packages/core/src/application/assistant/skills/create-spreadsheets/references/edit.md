...
```bash
"%FLAZZ_PYTHON%" "%FLAZZ_SKILL_ROOT%\create-spreadsheets\scripts\xlsx_unpack.py" input.xlsx /tmp/xlsx_work/
```
...
```bash
"%FLAZZ_PYTHON%" "%FLAZZ_SKILL_ROOT%\create-spreadsheets\scripts\xlsx_pack.py" /tmp/xlsx_work/ output.xlsx
"%FLAZZ_PYTHON%" "%FLAZZ_SKILL_ROOT%\create-spreadsheets\scripts\formula_check.py" output.xlsx
```
...
"%FLAZZ_PYTHON%" "%FLAZZ_SKILL_ROOT%\create-spreadsheets\scripts\xlsx_shift_rows.py" /tmp/xlsx_work/ insert 5 1

# Delete 1 row at row 8: all rows 9 and above shift up by 1
"%FLAZZ_PYTHON%" "%FLAZZ_SKILL_ROOT%\create-spreadsheets\scripts\xlsx_shift_rows.py" /tmp/xlsx_work/ delete 8 1
```
...
"%FLAZZ_PYTHON%" "%FLAZZ_SKILL_ROOT%\create-spreadsheets\scripts\libreoffice_recalc.py" output.xlsx /tmp/recalc.xlsx
"%FLAZZ_PYTHON%" "%FLAZZ_SKILL_ROOT%\create-spreadsheets\scripts\formula_check.py" /tmp/recalc.xlsx
```
